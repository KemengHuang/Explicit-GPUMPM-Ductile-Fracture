...
union un { float f; unsigned int ui; };
	...
	__device__
		...
		F[0] = a11; F[1] = a12; F[2] = a13; F[3] = a21; F[4] = a22; F[5] = a23; F[6] = a31; F[7] = a32; F[8] = a33;
		U[0] = u11; U[1] = u12; U[2] = u13; U[3] = u21; U[4] = u22; U[5] = u23; U[6] = u31; U[7] = u32; U[8] = u33;
		V[0] = v11; V[1] = v12; V[2] = v13; V[3] = v21; V[4] = v22; V[5] = v23; V[6] = v31; V[7] = v32; V[8] = v33;

		svd(F[0], F[1], F[2], F[3], F[4], F[5], F[6], F[7], F[8], U[0], U[1], U[2], U[3], U[4], U[5], U[6], U[7], U[8], S[0], S[1], S[2], V[0], V[1], V[2], V[3], V[4], V[5], V[6], V[7], V[8]);
