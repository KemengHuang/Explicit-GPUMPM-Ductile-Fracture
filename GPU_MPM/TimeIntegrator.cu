...
__global__ void undateGrid_kernal(const T dt, T** d_channels) {
    ...
    if (tag > 0.000001f)
    {
        ...
        T C = *((T*)((unsigned long long)d_channels[7] + idx * 7680) + cellid);
        //printf("C:  %f\n", C);
        T W = *((T*)((unsigned long long)d_channels[8] + idx * 7680) + cellid);
        //*((T*)((unsigned long long)d_channels[8] + idx * 7680) + cellid) = 0;
		//if (abs(W) < (T)1e-20) {
		//	//mass = 0;
		//	*((T*)((unsigned long long)d_channels[7] + idx * 7680) + cellid) = 0.f;
		//	*((T*)((unsigned long long)d_channels[9] + idx * 7680) + cellid) = 0.f;
		//}
		//else {
		//	*((T*)((unsigned long long)d_channels[7] + idx * 7680) + cellid) = C / W;
		//	//mass = 1.f / mass;
		//}
/*		if (abs(mass) < (T)1e-32) {
            *((T*)((unsigned long long)d_channels[7] + idx * 7680) + cellid) = 0.f;
            *((T*)((unsigned long long)d_channels[9] + idx * 7680) + cellid) = 0.f;
			...
			mass = 1.f / mass;
            *((T*)((unsigned long long)d_channels[7] + idx * 7680) + cellid) = __fdividef(C, W);
		}
		//mass = 1.f / mass;
        //for (int i = 0; i < 3; ++i)
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cellid) *= mass;
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cellid) *= mass;
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cellid) *= mass;
        //if (*((T*)((unsigned long long)d_channels[0] + idx * 7680) + cellid) != 0)
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cellid) +=  -10 * dt;
        mass = dt * mass;
        for (int i = 0; i < Dim; i++) {
            T test = *((T*)((unsigned long long)d_channels[i + 4] + idx * 7680) + cellid) * mass;

            if (!isnan(test) && !isinf(test)) {
                *((T*)((unsigned long long)d_channels[i + 1] + idx * 7680) + cellid) += test;
            }
        }
    ...
    T** d_channels)
{
    ...
    // sticky
    if (i <= 4) if (*((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) < 0.f) {
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) = 0.f;
    }
    if (i > N - 4) if (*((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) > 0.f) {
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) = 0.f;
    }
    if (j <= 4) if (*((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) < 0.f) {
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) = 0.f;
    }
    if (j > N - 4) if (*((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) > 0.f) {
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) = 0.f;
    }
    if (k <= 4) if (*((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) < 0.f) {
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
    }
    if (k > N - 4) if (*((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) > 0.f) {
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
    }
    ...
    T** d_channels, T t, T dx)
{
    ...
    if (disL < range) {
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) = -vv;
    }
    if (disR < range) {
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
	...
	T* vY = ((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell);
    if (j <= 4) if (*vY < 0.f) {
        *((T*)((unsigned long long)d_channels[2] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[1] + idx * 7680) + cell) = 0.f;
        *((T*)((unsigned long long)d_channels[3] + idx * 7680) + cell) = 0.f;
...
//    int cellid = threadIdx.x;
//    for (int i = 0; i < Dim; i++) {
//        *((T*)((unsigned long long)d_channels[i + 7] + idx * 7680) + cellid) = *((T*)((unsigned long long)d_channels[i + 1] + idx * 7680) + cellid)
//            - *((T*)((unsigned long long)d_channels[i + 7] + idx * 7680) + cellid);
//    }
//}
